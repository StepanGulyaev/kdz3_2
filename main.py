...
if __name__ == '__main__':
     ...
     task2.show_nash_max()
     graphics2.draw_pareto(task2.fpq_points,task2.status_quo_point)
     ...
     graphics2.draw_model(n,imitation_model1.v, imitation_model1.avg,False)
     ...
     graphics2.draw_model(n,imitation_model2.v, imitation_model1.avg,True)
